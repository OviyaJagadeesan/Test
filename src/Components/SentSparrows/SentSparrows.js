  ...
  return (
    <div>
      <div className="row topHeader">
        ...
        <div className="col-lg-3col-10 col-md-10 col-lg-6 col-xl-3 headerTitle">TITLE</div>
        <div className=" col-6 col-md-6 col-lg-4 col-xl-2  headerTitle">OUTCOME</div>
      ...
      <div className="row sparrowCard">
        {sentDetails&&sentDetails.map((spr) => (
          <div
            className="contentAllSpr"
          >
            <img className="col-2 col-md-2 col-lg-1 col-xl-1 alignItemsCss priorityImage" src={spr.priority}></img>
            <div className="col-10 col-md-10 col-lg-3 col-xl-3 titleText">{spr.title}</div>
